...
path_A = os.path.join(".", "sample_data", "itunes-amazon", "learn_data", "tableA.csv")
path_B = os.path.join(".", "sample_data", "itunes-amazon", "learn_data", "tableB.csv")
# Load the two tables.
...
path_train = os.path.join(
    ".", "sample_data", "itunes-amazon", "learn_data", "train.csv"
)
path_validation = os.path.join(
    ".", "sample_data", "itunes-amazon", "learn_data", "valid.csv"
)
path_test = os.path.join(".", "sample_data", "itunes-amazon", "learn_data", "test.csv")
# %%
import pandas as pd
...
# %%
save_path = os.path.join(".", "sample_data", "itunes-amazon", "merged_train.csv")
...
save_path = os.path.join(".", "sample_data", "itunes-amazon", "merged_test.csv")
...
save_path = os.path.join(".", "sample_data", "itunes-amazon", "merged_validation.csv")
merged_validation_df.to_csv(save_path, index=False)
###################################################
###################################################
# %%
feature_table = em.get_features_for_matching(A, B)
load_path = os.path.join(".", "sample_data", "itunes-amazon", "merged_train.csv")
...
train_H.head(5)
# %%
save_path = os.path.join(".", "sample_data", "itunes-amazon", "fe_train.csv")
...
# %%
save_path = os.path.join(".", "sample_data", "itunes-amazon", "fe_valid.csv")
validation_H.to_csv(save_path, index=False)
# %%
##################################################
##################################################
test_load_path = os.path.join(".", "sample_data", "itunes-amazon", "merged_test.csv")
...
save_path = os.path.join(".", "sample_data", "itunes-amazon", "fe_test.csv")
